...
alloc_proc(void) {
     ...
     */
     //LAB5 2012011300 : (update LAB4 steps)
    /*
     * below fields(add in LAB5) in proc_struct need to be initialized	
     *       uint32_t wait_state;                        // waiting state
     *       struct proc_struct *cptr, *yptr, *optr;     // relations between processes
	 */
     //LAB6 2012011300 : (update LAB5 steps)
    /*
    ...
    //LAB8:EXERCISE2 2012011300 HINT:need add some code to init fs in proc_struct, ...
        proc->filesp = NULL;
    }
    return proc;
}
...
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
    ...
    ret = -E_NO_MEM;
    //LAB4:EXERCISE2 2012011300
    //LAB8:EXERCISE2 2012011300  HINT:how to copy the fs in parent's proc_struct?
    /*
...
load_icode(int fd, int argc, char **kargv) {
    /* LAB8:EXERCISE2 2012011300  HINT:how to load the file with handler fd  in to process's memory? how to setup argc/argv?
     * MACROs or Functions:
